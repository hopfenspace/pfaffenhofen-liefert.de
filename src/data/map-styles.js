...
module.exports = {
  ...
  "sources": {
    "openmaptiles": {
      "type": "vector",
      "url": "https://api.maptiler.com/tiles/v3/tiles.json?key=AMbxxLVMej6iv4stQc0i"
    }
  },
  "glyphs": "https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=AMbxxLVMej6iv4stQc0i",
  "layers": [
    {
      "id": "background",
      "type": "background",
